(function ($) {
    ...
    $.ajaxChimp.translations = {
        ...
        'pt': {
            'submit': 'Registrando...',
            0: 'Um e-mail de confirmação foi enviado',
            1: 'Por favor, digite um valor',
            2: 'O e-mail deve conter pelo menos um @',
            3: 'email não é válido',
            4: 'email inválido (depois do @:)',
            5: 'Não foi possível enviar. Verifique novamente seu e-mail'
        }
    };
})(jQuery);
