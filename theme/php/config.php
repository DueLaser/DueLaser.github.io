<?
	...
	define('TO_NAME','Luiz');  //put your name
	define('TO_EMAIL','contato@duelaser.com');  //put your email

	define('TEMPLATE_PATH','template/default.php');


	define('SMTP_HOST','smtp.gmail.com'); //for example gmail: smtp.gmail.com
	define('SMTP_USERNAME','contato@duelaser.com'); //put your email
	define('SMTP_PASSWORD','teste'); //put your password
